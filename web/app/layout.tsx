...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en"><body>
    ...
    {children}
    <footer className="footer"><div className="wrap footerGrid"><div className="footerBrand"><span className="brandWord">Prompt <b>Machine</b></span><p>Reusable AI workflows organized around what you need to get done.</p></div><div className="footerMeta"><span>FREE LIBRARY / USEFUL STANDALONE WORKFLOWS</span><span>STARTER / USD 9 PRICE HYPOTHESIS · CHECKOUT OFF</span><span>FULL / USD 19 PRICE HYPOTHESIS · CHECKOUT OFF</span><span>FACTORY / PROMPT QUARRY · EVIDENCE BEFORE CLAIMS</span></div><div className="footerLinks"><Link href="/free/developer-starter-pack">Free Workflows</Link><Link href="/starter-collection">Starter $9</Link><Link href="/developer-pack">Full $19</Link><Link href="/collections">Collections</Link><Link href="/learn">Learn</Link><Link href="/license">License</Link></div></div></footer>
  </body></html>;
}
