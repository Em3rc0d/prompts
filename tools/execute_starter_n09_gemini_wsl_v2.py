#!/usr/bin/env python3
"""Prompt Machine Starter N09 — local WSL Gemini executor v2.
...
def load_and_validate() -> tuple[bytes, dict, dict, dict, dict, dict]:
    ...
    checks = {
        ...
        "pipeline_14": len(pipeline.get("gates") or []) == 14,
        "g05_mapping": (pipeline.get("gates") or [None] * 5)[4].get("id") == "G05_BASELINE_EXECUTION",
        "attempt_plan": plan.get("attempt_id") == "G05-BASELINE-002" and plan.get("state") == "PREPARED_FRESH_AUTH_REQUIRED",
    }
...
def main() -> int:
    ...
    if args.model != plan.get("model"):
        raise SystemExit("blocked: model differs from frozen Attempt 002 plan")
    ...
    try:
        ...
        raw = exc.read()
        receipt = {
            "schema": "prompt-machine-starter-n09-gemini-wsl-attempt-v2-failure",
        ...
        receipt = {
            "schema": "prompt-machine-starter-n09-gemini-wsl-attempt-v2-transport-failure",
            "attempt_id": "G05-BASELINE-002",
            "execution_id": execution_id,
            "case_id": CASE_ID,
            "provider": PROVIDER,
    ...
    try:
        ...
        receipt = {
            "schema": "prompt-machine-starter-n09-gemini-wsl-attempt-v2-invalid-response",
            "attempt_id": "G05-BASELINE-002",
            "execution_id": execution_id,
            "case_id": CASE_ID,
            "provider_requests_attempted": 1,
    ...
    if not output:
        ...
        receipt = {
            "schema": "prompt-machine-starter-n09-gemini-wsl-attempt-v2-empty-output",
            "attempt_id": "G05-BASELINE-002",
            "execution_id": execution_id,
            "case_id": CASE_ID,
            "provider_requests_attempted": 1,
    ...
    evidence = {
        "schema": "prompt-machine-starter-n09-gemini-wsl-observation-v2",
        "version": "2.0.0",
        "attempt_id": "G05-BASELINE-002",
        "execution_id": execution_id,
        "case_id": CASE_ID,
    ...
    write_json(
        ...
        {
            "schema": "prompt-machine-starter-n09-gemini-wsl-review-packet-v2",
            "attempt_id": "G05-BASELINE-002",
            "execution_id": execution_id,
            "case_id": CASE_ID,
