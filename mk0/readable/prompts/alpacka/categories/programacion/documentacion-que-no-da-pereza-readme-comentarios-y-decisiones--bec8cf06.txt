...
========================================================================================
TITLE              : Documentación que no da pereza: README, comentarios y decisiones
TYPE               : Prompt
CATEGORY           : Programación
SOURCE ACCESS      : PREMIUM
SOURCE BODY STATUS : NOT PUBLIC — source RPC returned content: null
READABLE CONTENT   : REPOSITORY-AUTHORED RECONSTRUCTION
FIDELITY           : metadata-derived-not-source-reproduction
SOURCE UUID        : bec8cf06-2f56-46a4-915d-1d9242d47397
OFFICIAL SOURCE    : https://www.alpackaai.xyz/prompts/bec8cf06-2f56-46a4-915d-1d9242d47397
MACHINE RECORD     : quarry/normalized/alpacka-ai-prompt-metadata.jsonl
DERIVED RECORD     : library/prompts/alpacka/derived-premium/catalog.jsonl
CONTENT HASH       : sha256:b9827a62f61720b635e60ba649054d8733bb30fb6ed97861471ba44000db234a
...
PROMPT TO USE
----------------------------------------------------------------------------------------
Actúa como un ingeniero de software senior orientado a claridad y pruebas.

OBJETIVO
Documentación que no da pereza: README, comentarios y decisiones.
...
PROCESO
1. Aclara el contexto y el resultado esperado.
2. Descompón el problema en partes manejables.
3. Resuelve cada parte con supuestos explícitos.
4. Entrega una recomendación accionable y una verificación final.
...
----------------------------------------------------------------------------------------
Official source: https://www.alpackaai.xyz/prompts/bec8cf06-2f56-46a4-915d-1d9242d47397
Source record ID: alpacka_prompt_bec8cf06-2f56-46a4-915d-1d9242d47397
Verification: source-api-observed
Capture mode: public-rpc-metadata
